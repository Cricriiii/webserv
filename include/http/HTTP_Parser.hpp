...
#define _IS_READ_ENCD_BODY(test_state)	((test_state) >= S_PARS_ENCD_DATA && (test_state) <= S_PARS_ENCD_END_LF)
#define _IS_READ_HEADERS(test_state)	((test_state) >= S_PARS_START_CR && (test_state) <= S_PARS_BLANK_LINE_LF)

...
public:
	...
	response_status_t	serialize_head(const HTTP_Response& response, resource_context_t& resource, char* target, size_t target_size);
	response_status_t	serialize_body(const HTTP_Response& response, resource_context_t& resource, char* target, size_t target_size);

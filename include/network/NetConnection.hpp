...
inline conn_state_t operator|(conn_state_t lhs, conn_state_t rhs) {
    return static_cast<conn_state_t>(static_cast<int>(lhs) |
                                     static_cast<int>(rhs));
}
...
inline poll_op_t operator|(poll_op_t lhs, poll_op_t rhs) {
    return static_cast<poll_op_t>(static_cast<int>(lhs) |
                                  static_cast<int>(rhs));
}
...
public:
    bool read_cgi_output(char* buffer, ssize_t* buffer_read,
